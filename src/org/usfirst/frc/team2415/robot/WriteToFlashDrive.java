...
public class WriteToFlashDrive {
	 ...
	 */
	public static void createBufferedWriter(String filename, BufferedWriter name_of_writer) {
	 ...
	 */
	public static void writeToFile(double currentValue, double desiredValue, BufferedWriter name_of_writer) {
		try {
	 ...
	 */
	public static void flushAndClose(BufferedWriter name_of_writer) {
		try {
